...
<div class="UpdateRole-Body">
    ...
    <div class="UpdateRole-Positioning">
        ...
        <div class="UpdateRole-Role">
            <div class="form-floating mb-2" style="display: flex;align-items:center;color:aliceblue">
                Role:
                <div class="UpdateRole-input-form">
                    <select id="Role" name="Role" class="form-control" style="background-color: transparent;color:whitesmoke" required>
        ...
        <div class="Profile-Submit-Button" style="text-align:left">
            <p><button style="font-size:18px;color:black" onclick="return confirm('Update, Continue?')">Save</button></p>
        </div>
    </div>
    @endforeach
    </form>
