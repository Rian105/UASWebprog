    ...
    <div class="AddProduct-Box">
        ...
        <form action="/AddProduct" method="post" enctype="multipart/form-data">
            ...
            <div class="AddProduct-Input-Form">
                ...
                <input type="text" style="background-color:aliceblue" class="form-control @error('Name') is-invalid @enderror" name="Name" placeholder="First name" aria-label="First name" required autofocus>
            </div>
            <div class="AddProduct-Input-Form">
            ...
            <div class="AddProduct-Input-Form">
                ...
                <input type="text" style="background-color:aliceblue" class="form-control" name="Price" placeholder="Price" aria-label="Price" required>
            </div>
            <div class="AddProduct-Input-Form mb-3">
                <label for="formFile" class="form-label">{{ __('Words.InputPictureProduct') }}</label>
                <input class="form-control" style="background-color:aliceblue" type="file" name="Photo" id="formFile" required>
            </div>
