    ...
    <div class="CartPage-Body">
                ...
                <div class="Description-Main-Detail">
                    ...
                    <div class="Description-Detail">
                        <form action="/CartPage" method="get">
                            @method('delete')
                            @csrf
                        <p><button style="font-size:18px;color:black" onclick="return confirm('Are You Sure?')">{{ __('Words.DeleteCart') }}</button></p>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="CartPage-Total">
            ...
            <div class="CartPage-Checkout-Box">
                <button style="font-size:18px;font-color:gray;" onclick="location.href='/Success'"><b>{{ __('Words.CheckOutCart') }}</b></button>
            </div>
        </div>
    </div>
